...
namespace Board.Host.DbMigrator.Migrations
{
    ...
    [Migration("20230506144414_AddTelegramClient")]
    partial class AddTelegramClient
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Board.Domain.TelegramClient", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Board.Domain.Category", b =>
                {
                    ...
                    b.HasOne("Board.Domain.TelegramClient", null)
                        .WithMany("SubscribedCategories")
                        .HasForeignKey("TelegramClientId");
            ...
            modelBuilder.Entity("Board.Domain.TelegramClient", b =>
                {
                    b.HasOne("Board.Domain.User", "User")
                        .WithOne("TelegramClient")
                        .HasForeignKey("Board.Domain.TelegramClient", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
